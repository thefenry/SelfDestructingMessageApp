...
import ivansued.com.selfdestructingmessageapp.adapters.SectionsPagerAdapter;
...
public class MainActivity extends ActionBarActivity implements ActionBar.TabListener {
            ...
            switch (which){
                ...
                case 1: //Take Vid
                    ...
                    if (mMediaUri == null){
                        ...
                        takeVideoIntent.putExtra(MediaStore.EXTRA_VIDEO_QUALITY, 0);//Low quality video
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK){
            ...
            //Starts the recipient activity when successfully setting mediaUri.
            Intent recipientsIntent = new Intent(this, RecipientsActivity.class);
            recipientsIntent.setData(mMediaUri);
            String fileType;
            if (requestCode == FIND_PHOTO_REQUEST || requestCode == TAKE_PHOTO_REQUEST){
